...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <input id="name" type="text" class="form-control" name="name" value="{{$usuario->name}}" required autofocus placeholder="Nombre..">    
            @if ($errors->has('name'))
        ...
        <div class="form-group {{ $errors->has('email') ? ' alert-danger' : '' }}">
            ...
            <input id="email" type="email" class="form-control" name="email" value="{{$usuario->email}}" required placeholder="Correo electrónico.." readonly>    
