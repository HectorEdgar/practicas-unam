        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/documento')}}/{{$documento->Id_doc}}">Resumen Doc. ({{ $documento->Id_doc}})</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Administrar Documento y Persona</li>
                </ol>
            </nav>
    ...
    <!-- Tabla de personas agregados -->
        <div class="table-responsive table-responsive-xl table-responsive-md table-responsive-lg table-responsive-sm">        
            ...
            <table class="table table-hover table-sm ">
                ...
                <tbody>
                    @foreach($personasdelDocumento as $item)
                        <tr>
                    ...
                    @include('documentoPersona.modal2')
                    @endforeach
                </tbody>
            </table>
...
<center><h3>Vincular persona existente</h3></center>
       ...
       <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                @include('documentoPersona.search')
            </div>
            <!--Etiquetas de la imagen de agregar-->
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <a href="{{URL::action('DocumentoPersonaController@nuevoPersonaDocumento',$documento->Id_doc)}}" class="btn btn-outline-success col-sm-12 col-xs-12" >
        ...
        <div class="table-responsive table-responsive-xl table-responsive-md table-responsive-lg table-responsive-sm">        
            ...
            <table class="table table-hover table-sm ">
                ...
                <tbody>
                    ...
                    @include('documentoPersona.modal')
                    @endforeach
                </tbody>
            </table>
           
            @include('documentoPersona.paginador')
        </div>
