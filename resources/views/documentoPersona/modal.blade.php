...
{!!Form::open(array('url'=>'cntrl_persona','method'=>'POST','autocomplete'=>'off'))!!} {{Form::token()}}
        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se vinculará la Persona: </center><br>
                    <center><strong>{{$item->nombre}} {{$item->apellidos}} </strong> </center><br> 
