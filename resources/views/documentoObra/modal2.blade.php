...
{!! Form::open(['method' => 'DELETE', 'route' => ['cntrl_obra.destroy2', $item->id_obra,$documento->Id_doc]]) !!}
        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se desvinculará la obra:</center> <br>
                    <center><strong>{{$item->id_obra}} </strong></center> <br> 
