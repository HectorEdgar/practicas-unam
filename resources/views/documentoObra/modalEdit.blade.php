...
<div class="modal fade" id="modalEdit-{{$item->id_obra}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se editará el vínculo  la Obra: </center><br>
                ...
                <br><center>¿Está bien?</center>
                 ...
                 <input type="hidden" name="editar" class="form-control" value="true">
