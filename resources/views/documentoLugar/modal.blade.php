...
{!!Form::open(array('url'=>'cntrl_lugar','method'=>'POST','autocomplete'=>'off'))!!} {{Form::token()}}
        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se vinculará el Lugar: </center><br>
                    <center><strong>{{$item->ubicacion}} {{$item->pais}} </strong> </center><br> 
