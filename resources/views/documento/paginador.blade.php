    ...
    <nav aria-label="paginador">
        <ul class="pagination justify-content-center">
            ...
            @if ($page==1)
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/documento')}}?page={{$page-1}}&searchText={{$searchText}}&role={{$role}}" tabindex="-1">Anterior</a>
                    </li>
            @endif  
            <?php
            ...
            @if ($pivote>1)
                @if ($pivote==2)
                    <li class="page-item">
                        <a class="page-link" href="{{url('/documento')}}?page=&searchText={{$searchText}}&role={{$role}}">1</a>
                    </li>
                    <li class="page-item">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/documento')}}?page=1&searchText={{$searchText}}&role={{$role}}">1</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href="{{url('/documento')}}?page=2&searchText={{$searchText}}&role={{$role}}">2</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href=""></a>
                    </li>
            ...
            @for ($i = $pivote; $i < $totalpaginadores; $i++)
                ...
                @if ($page==$i)
                    <li class="page-item active">
                        <a class="page-link" href="{{url('/documento')}}?page={{$i}}&searchText={{$searchText}}&role={{$role}}">{{$i}} <span class="sr-only">(current)</span></a>
                    </li>
                    @else
                        <li class="page-item">
                            <a class="page-link" href="{{url('/documento')}}?page={{$i}}&searchText={{$searchText}}&role={{$role}}">{{$i}}</a>
                        </li>
                @endif
            ...
            @if ($page==$totalpaginadores)
                <li class="page-item active">
                    <a class="page-link" href="{{url('/documento')}}?page={{$totalpaginadores}}&searchText={{$searchText}}&role={{$role}}">{{$totalpaginadores}}</a>
                </li>
                @else
                <li class="page-item">
                    <a class="page-link" href=""></a>
            ...
            @if ($page==$totalpaginadores)
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/documento')}}?page={{$page+1}}&searchText={{$searchText}}&role={{$role}}">Siguiente</a>
                    </li>
            @endif
        </ul>
    </nav>
