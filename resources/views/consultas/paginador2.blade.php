    ...
    <nav aria-label="paginador">
        <ul class="pagination justify-content-center">
            ...
            @if ($page==1)
                ...
                @else
                    <li class="page-item">
                    <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page={{$page-1}}&searchText={{$searchText}}&proyecto={{$proyecto}}" tabindex="-1">Anterior</a>
                    </li>
            @endif  
            <?php
            ...
            @if ($pivote>1)
                @if ($pivote==2)
                    <li class="page-item">
                        <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page=&searchText={{$searchText}}&proyecto={{$proyecto}}">1</a>
                    </li>
                    <li class="page-item">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page=1&searchText={{$searchText}}&proyecto={{$proyecto}}">1</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page=2&searchText={{$searchText}}&proyecto={{$proyecto}}">2</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href=""></a>
                    </li>
            ...
            @for ($i = $pivote; $i < $totalpaginadores; $i++)
                ...
                @if ($page==$i)
                    <li class="page-item active">
                        <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page={{$i}}&searchText={{$searchText}}&proyecto={{$proyecto}}">{{$i}} <span class="sr-only">(current)</span></a>
                    </li>
                    @else
                        <li class="page-item">
                            <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page={{$i}}&searchText={{$searchText}}&proyecto={{$proyecto}}">{{$i}}</a>
                        </li>
                @endif
            ...
            @if ($page==$totalpaginadores)
                <li class="page-item active">
                    <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page={{$totalpaginadores}}&searchText={{$searchText}}&proyecto={{$proyecto}}">{{$totalpaginadores}}</a>
                </li>
                @else
                <li class="page-item">
                    <a class="page-link" href=""></a>
            ...
            @if ($page==$totalpaginadores)
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/consultas')}}?estatus={{$doc->revisado}}&page={{$page+1}}&searchText={{$searchText}}&proyecto={{$proyecto}}">Siguiente</a>
                    </li>
            @endif
        </ul>
    </nav>
