...
<div class="modal fade" id="modal2-delete-{{$item->id_proyecto}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">   
{!! Form::open(['method' => 'DELETE', 'route' => ['obra_proyecto.destroy2', $item->id_proyecto,$obra->id_obra]]) !!}
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se desvinculará el Proyecto:</center> <br>
                    <center><strong>{{$item->id_proyecto}} {{$item->proyecto}} </strong></center> <br> 
