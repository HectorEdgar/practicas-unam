    ...
    <nav aria-label="paginador">
        <ul class="pagination justify-content-center">
            ...
            @if ($page==1)
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page={{$page-1}}&searchText={{$searchText}}" tabindex="-1">Anterior</a>
                    </li>
            @endif  
            <?php
            ...
            @if ($pivote>1)
                @if ($pivote==2)
                    <li class="page-item">
                        <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page=&searchText={{$searchText}}">1</a>
                    </li>
                    <li class="page-item">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page=1&searchText={{$searchText}}">1</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page=2&searchText={{$searchText}}">2</a>
                    </li>
                    <li class="page-item">
                        <a class="page-link" href=""></a>
                    </li>
            ...
            @for ($i = $pivote; $i < $totalpaginadores; $i++)
                ...
                @if ($page==$i)
                    <li class="page-item active">
                        <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page={{$i}}&searchText={{$searchText}}">{{$i}} <span class="sr-only">(current)</span></a>
                    </li>
                    @else
                        <li class="page-item">
                            <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page={{$i}}&searchText={{$searchText}}">{{$i}}</a>
                        </li>
                @endif
            ...
            @if ($page==$totalpaginadores)
                <li class="page-item active">
                    <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page={{$totalpaginadores}}&searchText={{$searchText}}">{{$totalpaginadores}}</a>
                </li>
                @else
                <li class="page-item">
                    <a class="page-link" href=""></a>
            ...
            @if ($page==$totalpaginadores)
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{url('/cntrl_proyecto')}}/ligar/{{$documento->Id_doc}}?page={{$page+1}}&searchText={{$searchText}}">Siguiente</a>
                    </li>
            @endif
        </ul>
    </nav>
