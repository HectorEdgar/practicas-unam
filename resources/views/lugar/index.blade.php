...
<div class="alert alert-warning">
  <strong>¡Aviso! </strong> {{Session::get('message4')}}
</div>
@endif
    ...
    <div class="row">
       ...
       <div class="row">
            ...
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <a href="{{url('/lugar')}}/create" class="btn btn-outline-success col-sm-12 col-xs-12" >
                    ...
                    @foreach($lugares as $item)
                        <tr>
                            ...
                            <td class="text-center align-middle ">
                                <a href="{{URL::action('LugarController@edit',$item ->id_lugar)}}">
                                ...
                                <a href="{{URL::action('LugarController@show',$item ->id_lugar)}}">
