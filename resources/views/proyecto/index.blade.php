    ...
    <div class="row">
       ...
       <div class="row">
            ...
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <a href="{{url('/proyecto')}}/create" class="btn btn-outline-success col-sm-12 col-xs-12" >
                ...
                <tbody>
                    @foreach($proyectos as $item)
                        <tr>
                            ...
                            <th scope="row"  class="text-center align-middle">{{$item ->proyecto}}</td>

                            <td class="text-center align-middle ">
                                <a href="{{URL::action('ProyectoController@edit',$item ->id_proyecto)}}">
