...
<div class="modal fade" id="modal2-delete-{{$item->Id_eje}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">   
{!! Form::open(['method' => 'DELETE', 'route' => ['obra_eje.destroy2', $item->Id_eje,$obra->id_obra]]) !!}
        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se desvinculará el Eje:</center> <br>
