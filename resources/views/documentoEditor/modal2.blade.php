...
<div class="modal fade" id="modal2-delete-{{$item->orden}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    {{Form::Open(array('action'=>array('DocumentoEditorController@destroy',$item->orden),'method'=>'delete'))}}
        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se desvinculará el Editor:</center> <br>
                    <center><strong>{{$item->fk_editor}} </strong></center> <br> 
