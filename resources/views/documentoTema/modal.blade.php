...
{!!Form::open(array('url'=>'cntrl_tema','method'=>'POST','autocomplete'=>'off'))!!} {{Form::token()}}
    <div class="modal-dialog modal-dialog-centered" role="document">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se vinculará el Tema: </center><br>
                    <center><strong>{{$item->descripcion}} </strong> </center><br> 
        ...
        <input type="hidden" name="fk_tema" class="form-control" value="{{$item->id_tema}}">
            ...
            <div class="modal-footer">
                ...
                <button type="temamit" class="btn btn-primary">Confirmar</button>
            </div>
        </div>
    </div>
    {{Form::Close()}}
