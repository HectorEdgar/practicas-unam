        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('/documento')}}/{{$documento->Id_doc}}">Resumen Doc. ({{ $documento->Id_doc}})</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Administrar Documento y Tema</li>
                </ol>
            </nav>
    ...
    <!-- Tabla de temas agregados -->
        <div class="table-responsive table-responsive-xl table-responsive-md table-responsive-lg table-responsive-sm">        
            ...
            <table class="table table-hover table-sm ">
                ...
                <tbody>
                    @foreach($temasdelDocumento as $item)
                        <tr>
        ...
        <div class="table-responsive table-responsive-xl table-responsive-md table-responsive-lg table-responsive-sm">        
            ...
            <table class="table table-hover table-sm ">
                ...
                <tbody>
                    ...
                    @include('documentoTema.modal')
                    @endforeach
                </tbody>
            </table>
           
            @include('documentoTema.paginador')
        </div>
