...
{!!Form::open(array('url'=>'cntrl_institucion','method'=>'POST','autocomplete'=>'off'))!!} {{Form::token()}}
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <p><center>Se vinculará la Institucion: </center><br>
                    <center><strong>{{$item->nombre}} {{$item->siglas}} </strong> </center><br> 
        ...
        <input type="hidden" name="fk_instit" class="form-control" value="{{$item->Id_institucion}}">
