...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('/documento')}}/{{$documento->Id_doc}}">Resumen Doc. ({{ $documento->Id_doc}})</a></li>
                <li class="breadcrumb-item active" aria-current="page">Administrar Documento y Institución</li>
            </ol>
        </nav>
    ...
    <center><h3>Vincular Institución existente</h3></center>
        <!--Etiquetas del formulario de busqueda-->
       <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                @include('documentoInstitucion.search')
            </div>
            <!--Etiquetas de la imagen de agregar-->
            <div class="col-xl-1 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <a href="{{URL::action('DocumentoInstitucionController@nuevoInstitucionDocumento',$documento->Id_doc)}}" class="btn btn-outline-success col-sm-12 col-xs-12" >
        ...
        <div class="table-responsive table-responsive-xl table-responsive-md table-responsive-lg table-responsive-sm">        
            ...
            <table class="table table-hover table-sm ">
                ...
                <tbody>
                    ...
                    @include('documentoInstitucion.modal')
                    @endforeach
                </tbody>
            </table>
           
            @include('documentoInstitucion.paginador')
        </div>
    ...
    <!-- Tabla de institucions agregados -->
        <div class="table-responsive table-responsive-xl table-responsive-md table-responsive-lg table-responsive-sm">        
            ...
            <table class="table table-hover table-sm ">
                ...
                <tbody>
                    @foreach($institucionesdelDocumento as $item)
                        <tr>
                           <th scope="row"  class="text-center align-middle">{{$item ->Id_institucion}}</td>
                            <td class="text-center align-middle">{{$item ->nombre}}</td>
                            <td class="text-center align-middle">{{$item ->siglas}}</td>
                    ...
                    @include('documentoInstitucion.modal2')
                    @endforeach
                </tbody>
            </table>
